...
--               Info/S4/APP2/pb_logique_seq/pb_logique_seq.gen/sources_1/bd/design_1/ip/design_1_module_commande_0_0/design_1_module_commande_0_0_sim_netlist.vhdl}
...
architecture STRUCTURE of design_1_module_commande_0_0_conditionne_btn_v7 is
  signal \FSM_sequential_Sreg[0]_i_2_n_0\ : STD_LOGIC;
...
\FSM_sequential_Sreg[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"22F2"
    )
        port map (
...
\FSM_sequential_Sreg[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of design_1_module_commande_0_0_module_commande is
  ...
  signal Sreg : STD_LOGIC_VECTOR ( 1 to 1 );
